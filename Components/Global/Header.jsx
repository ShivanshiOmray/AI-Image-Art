...
const Header = () => {
  ...
  return (
    <div
      className="fixed w-screen bottom-0 sm:top-0 z-50 flex flex-row items-center justify-between backdrop-blur bg-opacity-80 border-t sm:border-b border-opacity-50 text-sm select-none bg-zinc-900 border-t-zinc-700 sm:border-t-0 sm:boder-b-zinc-700"
      style={{ height: 56 }}
    >
      <Link
        href="/"

...
import { ArrowDown, Tick } from "../SVG/index";
    ...
    >
      ...
      <div className="w-full flex flex-col items-center">
        <div className="w-full px-3 pt-3 flex space-x-1 items-center justify-center pr-12">
          <button
            className="flex cursor-pointer select-none hover:bg-zinc-900 hover:bg-opacity-50 pl-3 pr-3 pr-2.5 py-2 items-center justify-center space-x-1.5 rounded focus:outline-none text-xs text-zinc-200"
            type="button"
            onClick={() =>
